...
import { getTables, updateTableStatus, createTable, resetTable, getTableById, deleteTable } from "../controllers/table.controller.js";
...
router.delete("/:id", protect, requireRole("restaurant_owner"), deleteTable);
